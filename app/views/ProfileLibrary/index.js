...
class ProfileLibraryView extends React.Component {
	...
	render = () => {
		...
		return (
			<SafeAreaView style={{ backgroundColor: themes[theme].nextGenBackground }} testID='directory-view' theme={theme}>
				<StatusBar theme={theme} />
				<FlatList
					data={data}
					style={[styles.list, { backgroundColor: themes[theme].nextGenBackground }]}
					contentContainerStyle={[styles.listContainer, { backgroundColor: themes[theme].nextGenBackground }]}
