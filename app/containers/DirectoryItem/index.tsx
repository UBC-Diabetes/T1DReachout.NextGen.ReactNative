...
const DirectoryItem = ({
	...
	return (
		<Touch onPress={onPress} style={[styles.directoryItemButton, { backgroundColor: colors.nextGenSurface }, style]} testID={testID}>
				...
				<View style={styles.directoryItemTextContainer}>
					<View style={styles.directoryItemTextTitle}>
						...
						<View style={styles.directoryItemNameContainer}>
							<Text style={[styles.directoryItemName, { color: colors.nextGenText }]} numberOfLines={1}>
								{title}{age ? `, ${age}` : ''}
							</Text>
						</View>
					</View>
					{t1dSince ? (
						<Text style={[styles.directoryItemInfo, { color: colors.nextGenTextSecondary }]} numberOfLines={1}>
